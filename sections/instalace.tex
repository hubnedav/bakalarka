...
Vazby mezi součástkami, které nebyly automaticky rozpoznány je možné opravit přidáním odpovídajících dvojic ID do souboru \mintinline{console}{app/Resources/relations/part_model.yml}.
