...
0
    ...
    \begin{itemize}
        ...
        Na obrázku \ref{obrazek-ldraw-shortcut} je možné vidět render součástky \textit{970c00} (nahoře) skládající se ze součástek \textit{3815}, \textit{3816}, \textit{3817} (dole).
